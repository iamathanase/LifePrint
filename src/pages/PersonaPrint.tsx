            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div className="flex-1">
                  ...
                  <Button className="mt-4 bg-gradient-to-r from-primary to-accent text-primary-foreground hover:opacity-90">
                    Begin Assessment
                  </Button>
                </div>
              </div>
          ...
          <Card className="glass-card p-8">
            ...
            <div className="grid grid-cols-5 gap-4">
              {["😊", "😐", "😔", "😤", "🤗"].map((emoji, i) => (
                <button
                  key={i}
                  className="glass-card p-4 text-4xl hover:scale-110 transition-transform duration-300 hover:bg-primary/10"
                >
                  {emoji}
                </button>
              ))}
